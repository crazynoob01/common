...
class StandardDeserializationClassWithOverrideAsArray implements CanBeMappedToJsonModel {
    use OutputsObjectVarsAsJsonSerializable;

    public function __construct(
        #[AsModel(class: OverrideClass::class)]
        private ClassToOverride $classToOverride
    ) {
    }
